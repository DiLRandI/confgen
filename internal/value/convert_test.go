...
func TestScalarConversion(t *testing.T) {
	cases := []struct {
		...
		{String, "", false, "", true}, {Path, " ./data ", true, " ./data ", true}, {Bool, false, false, false, true}, {Bool, "FALSE", true, false, true}, {Bool, "1", true, true, true}, {Bool, "false", false, nil, false},
		{Int, 0, false, 0, true}, {Int, "0", true, 0, true}, {Int, " 1", true, nil, false}, {Int, "1", false, nil, false}, {Int, 1.0, false, nil, false}, {Int, json.Number("1.0"), false, nil, false},
		{Int64, int64(math.MinInt64), false, int64(math.MinInt64), true}, {Int64, "9223372036854775808", true, nil, false}, {Int64, "-9223372036854775809", true, nil, false},
		{Uint, uint(0), false, uint(0), true}, {Uint, "-1", true, nil, false}, {Uint64, uint64(math.MaxUint64), false, uint64(math.MaxUint64), true}, {Uint64, "18446744073709551616", true, nil, false},
		{Float64, 1.5, false, 1.5, true}, {Float64, json.Number("1e2"), false, float64(100), true}, {Float64, "NaN", true, nil, false}, {Float64, "Inf", true, nil, false}, {Float64, math.Inf(-1), false, nil, false}, {Float64, "1e999", true, nil, false},
		{Duration, "1h30m", false, 90 * time.Minute, true}, {Duration, "2d", true, nil, false}, {Duration, 30, false, nil, false}, {Duration, "2562048h", true, nil, false},
		{String, nil, false, nil, false}, {String, true, false, nil, false},
	}
	for i, c := range cases {
